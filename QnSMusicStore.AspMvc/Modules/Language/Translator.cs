...
using QnSMusicStore.AspMvc.Models.Modules.Language;
using QnSMusicStore.Contracts.Modules.Language;
using QnSMusicStore.Contracts.Persistence.Account;
using AccountManger = QnSMusicStore.Adapters.Modules.Account.AccountManager;

namespace QnSMusicStore.AspMvc.Modules.Language
{
    public partial class Translator
    {
        ...
        private static string CreatePredicate() => $"AppName.Equals(\"{nameof(QnSMusicStore)}\") && {nameof(KeyLanguage)} == {(int)KeyLanguage} && {nameof(ValueLanguage)} == {(int)ValueLanguage}";
            ...
            if (handled == false)
            {
                ...
                try
                {
                    ...
                    foreach (var item in keyValuePairs.Where(i => i.Key.HasContent()))
                    {
                        ...
                        if (entity != null)
                        {
                            entity.AppName = nameof(QnSMusicStore);
