namespace QnSMusicStore.Logic.DataContext.Db
{
	...
	partial class QnSMusicStoreDbContext : GenericDbContext
	{
		...
		partial void DoModelCreating(ModelBuilder modelBuilder)
		{
			...
			modelBuilder.Entity<Entities.Persistence.App.Album>().Property(p => p.Timestamp).IsRowVersion();
			...
			modelBuilder.Entity<Entities.Persistence.App.Artist>().Property(p => p.Timestamp).IsRowVersion();
			...
			modelBuilder.Entity<Entities.Persistence.App.Genre>().Property(p => p.Timestamp).IsRowVersion();
			...
			modelBuilder.Entity<Entities.Persistence.App.Track>().Property(p => p.Timestamp).IsRowVersion();
