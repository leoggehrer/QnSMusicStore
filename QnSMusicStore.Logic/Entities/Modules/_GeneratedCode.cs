namespace QnSMusicStore.Logic.Entities.Modules.Language
{
	using System;
	partial class Translation : QnSMusicStore.Contracts.Modules.Language.ITranslation
	{
		static Translation()
		{
			ClassConstructing();
		...
		{
			if (!(obj is QnSMusicStore.Contracts.Modules.Language.ITranslation instance))
			{
				return false;
			}
			return base.Equals(instance) && Equals(instance);
		}
		protected bool Equals(QnSMusicStore.Contracts.Modules.Language.ITranslation other)
		{
			if (other == null)
			{
				return false;
